	dojo._hasResource["test.query"]=true;
	dojo.provide("test.query");

define("test.query", ["dojo", "dojox", "dojo/data/util/sorter", "dojo/string"], function(dojo, dojox) {

	return dojo.declare("test.query", null, {
		// summary:
